...
atlético_madrid = Team.create!(name: "Atlético Madrid", sport: "Football", logo: "logo-club/atletico-madrid.png")
...
hobart = Team.create!(name: "Hurricanes", sport: "Cricket", logo: "logo-club/hobart.png")
sydney = Team.create!(name: "Sixers", sport: "Cricket", logo: "logo-club/sydney.png")
...
bet_8 = Bet.create!(user: user_2, progress: 0, match: match_13)
