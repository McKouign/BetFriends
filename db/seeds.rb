...
atlético_madrid = Team.create!(name: "Atlético de Madrid", sport: "Football")
...
man_city = Team.create!(name: "Manchester City", sport: "Football")
liverpool = Team.create!(name: "Liverpool FC", sport: "Football")
aston_villa= Team.create!(name: "Aston Villa FC", sport: "Football")
luton_town = Team.create!(name: "Luton Town FC", sport: "Football")
crystal_palace = Team.create!(name: "Crystal Palace FC", sport: "Football")
psg = Team.create!(name: "Paris Saint-Germain", sport: "Football")
marseille = Team.create!(name: "Olympique de Marseille", sport: "Football")
...
bet_1 = Bet.create!(user: user_1, participation: participation_1, progress: 0, match: match_10)
bet_2 = Bet.create!(user: user_2, participation: participation_1, progress: 0, match: match_11)
bet_3 = Bet.create!(user: user_1, progress: 0, match: match_8)
bet_4 = Bet.create!(user: user_2, participation: participation_2, progress: 0, match: match_12)
bet_5 = Bet.create!(user: user_2, participation: participation_1, progress: 0, match: match_13)
