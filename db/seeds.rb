...
match_1 = Match.create!(sport: "Football", date: DateTime.new(2023,12,22,21,00,00), funbet: false)
match_2 = Match.create!(sport: "Football", date: DateTime.new(2023,12,22,16,15,00), funbet: false)
match_3 = Match.create!(sport: "Football", date: DateTime.new(2023,12,23,14,00,00), funbet: false)
match_4 = Match.create!(sport: "Football", date: DateTime.new(2023,12,23,18,30,00), funbet: false)
match_5 = Match.create!(sport: "Football", date: DateTime.new(2023,12,23,15,00,00),funbet: false)
match_6 = Match.create!(sport: "Football", date: DateTime.new(2023,12,23,13,30,00), funbet: false)
match_7 = Match.create!(sport: "Football", date: DateTime.new(2023,12,24,17,00,00), funbet: false)
match_8 = Match.create!(sport: "Football", date: DateTime.new(2023,12,24,21,00,00), funbet: false)
match_9 = Match.create!(sport: "Football", date: DateTime.new(2023,12,24,17,00,00), funbet: false)
match_10 = Match.create!(sport: "Football", date: DateTime.new(2023,12,15,21,00,00), funbet: false)
match_11 = Match.create!(sport: "Football", date: DateTime.new(2023,12,16,21,00,00), funbet: false)
match_12 = Match.create!(sport: "Football", date: DateTime.new(2023,12,16,20,30,00), funbet: false)
match_13 = Match.create!(sport: "Football", date: DateTime.new(2023,12,17,17,00,00), funbet: false)
match_14 = Match.create!(sport: "Football", date: DateTime.new(2023,12,17,21,00,00), funbet: false)
match_15 = Match.create!(sport: "Football", date: DateTime.new(2023,12,17,21,00,00), funbet: false)
match_16 = Match.create!(sport: "Football", date: DateTime.new(2023,12,17,20,30,00), funbet: false)
match_17 = Match.create!(sport: "Football", date: DateTime.new(2023,12,17,17,00,00), funbet: false)
match_18 = Match.create!(sport: "Football", date: DateTime.new(2023,12,17,17,00,00), funbet: false)
match_19 = Match.create!(sport: "NFL", date: DateTime.new(2023,12,15,10,00,00), funbet: true)
match_20 = Match.create!(sport: "Cricket", date: DateTime.new(2023,12,24,9,15,00), funbet: true)
...
bet_1 = Bet.create!(user: user_1, match: match_1)
...
bet_14 = Bet.create!(user: user_2, match: match_1)
...
bet_48 = Bet.create!(user: user_5, match: match_2)
