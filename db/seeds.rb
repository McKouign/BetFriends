...
user_reward_1 = UserReward.create!(reward: reward_1, user: user_2, target: user_2)
user_reward_2 = UserReward.create!(reward: reward_2, user: user_2, target: user_2)
user_reward_3 = UserReward.create!(reward: reward_3, user: user_2, target: user_2)
user_reward_4 = UserReward.create!(reward: reward_4, user: user_2, target: user_2)

bet_1 = Bet.create!(user: user_2, progress: 0, match: match_10, user_reward: user_reward_2)
...
bet_7 = Bet.create!(user: user_2, progress: 0, participation: participation_23, match: match_12, user_reward: user_reward_1)
