...
participation_1 = Participation.create!(team: barcelone, match: match_1, odd: 1.80)
participation_2 = Participation.create!(team: madrid, match: match_1, odd: 2.15)
...
participation_1 = Participation.create!(team: lorient, match: match_3, odd: 1.7)
participation_2 = Participation.create!(team: rennes, match: match_3, odd: 3)
